...
class EladchKitextsCommandLibraryExtension(omni.ext.IExt):
    # ext_id is current extension id. It can be used with extension manager to query additional information, like where
    # this extension is located on filesystem.
    def on_startup(self, ext_id):
        print("[EladCh.kitexts.command.library] EladCh kitexts command library startup")
        ...
        with self._window.frame:
            with ui.VStack():
                ...
                ui.Button("Increase", clicked_fn=lambda: on_click())

    def on_shutdown(self):
        print("[EladCh.kitexts.command.library] EladCh kitexts command library shutdown")
